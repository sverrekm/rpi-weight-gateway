...
const App: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', color: '#111', background: '#f8fafc', minHeight: '100vh' }}>
      <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 16, borderBottom: '1px solid #e5e7eb', background: '#fff' }}>
      ...
      <footer style={{ textAlign: 'center', padding: 16, color: '#6b7280' }}>MIT Licensed</footer>
    </div>
  )
}
